...
output "connectivity_network_area_id" {
  description = "The network area ID of the legacy default connectivity area."
  value       = try(module.connectivity[0].network_area_id["default"], null)
}

output "connectivity_network_area_ids_by_area" {
  description = "Map of connectivity network area keys to their IDs."
  value       = coalesce(try(module.connectivity[0].network_area_id, null), {})
}

output "connectivity_network_area_ids_by_region" {
  description = "Map of regions to network area keys and IDs for regional connectivity deployments."
  value = {
    eu01 = coalesce(try(module.connectivity_eu01[0].network_area_id, null), {})
    eu02 = coalesce(try(module.connectivity_eu02[0].network_area_id, null), {})
  }
}

output "connectivity_project_id" {
  description = "The project ID of the legacy default connectivity area."
  value       = try(module.connectivity[0].project_id["default"], null)
}

output "connectivity_project_ids_by_area" {
  description = "Map of connectivity network area keys to their project IDs."
  value       = coalesce(try(module.connectivity[0].project_id, null), {})
}

output "connectivity_firewall_public_ip" {
  description = "The public IP of the legacy default area's primary firewall node."
  value       = try(module.connectivity[0].firewall_public_ip["default"], null)
}

output "connectivity_firewall_public_ips_by_area" {
  description = "Map of network area keys to primary firewall public IPs."
  value       = coalesce(try(module.connectivity[0].firewall_public_ip, null), {})
}

output "connectivity_firewall_backup_public_ip" {
  description = "The public IP of the legacy default area's backup firewall. Null without connectivity.firewall.ha."
  value       = try(module.connectivity[0].firewall_backup_public_ip["default"], null)
}

output "connectivity_firewall_next_hop_ip" {
  description = "The legacy default area's next hop for corporate landing-zone routes."
  value       = try(module.connectivity[0].firewall_next_hop_ip["default"], null)
}

output "connectivity_firewall_next_hop_ips_by_area" {
  description = "Map of network area keys to firewall next-hop IPs."
  value       = coalesce(try(module.connectivity[0].firewall_next_hop_ip, null), {})
}

output "connectivity_vpn_gateway_id" {
  description = "The ID of the legacy default area's VPN gateway."
  value       = try(module.connectivity[0].vpn_gateway_id["default"], null)
}

output "connectivity_vpn_gateway_ids_by_area" {
  description = "Map of network area keys to VPN gateway IDs."
  value       = coalesce(try(module.connectivity[0].vpn_gateway_id, null), {})
}
...
output "connectivity_vpn_public_ips" {
  ...
  value       = coalesce(try(module.connectivity[0].vpn_public_ips, null), {})
}

output "connectivity_vpn_internal_next_hop_ips" {
  description = "Network area side IPs of the hub VPN gateway tunnels."
  value       = coalesce(try(module.connectivity[0].vpn_internal_next_hop_ips, null), {})
}
...
output "connectivity_vpn_connection_ids" {
  ...
  value       = coalesce(try(module.connectivity[0].vpn_connection_ids, null), {})
}
...
output "platform_kubernetes_projects" {
  ...
  value = merge({
    ...
    for k, v in module.platform_kubernetes_eu01 : k => {
      project_id                = v.project_id
      project_name              = v.project_name
      ske_cluster_name          = v.ske_cluster_name
      ske_cluster_region        = v.ske_cluster_region
    ...
    for k, v in module.platform_kubernetes_eu02 : k => {
      project_id                = v.project_id
      project_name              = v.project_name
      ske_cluster_name          = v.ske_cluster_name
      ske_cluster_region        = v.ske_cluster_region
...
output "landing_zone_projects" {
  ...
  value = merge({
    ...
    for k, v in module.landing_zone_eu01 : k => {
      project_id                     = v.project_id
      project_name                   = v.project_name
      dns_zone_name                  = v.dns_zone_dns_name
      secretsmanager_instance_id     = v.secretsmanager_instance_id
    ...
    for k, v in module.landing_zone_eu02 : k => {
      project_id                     = v.project_id
      project_name                   = v.project_name
      dns_zone_name                  = v.dns_zone_dns_name
      secretsmanager_instance_id     = v.secretsmanager_instance_id
